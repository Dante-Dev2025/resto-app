<!-- --- VIEW: Pesanan View ---
Menampilkan logika tab filter (Proses vs Selesai), render kartu pesanan berdasarkan status,
dan fungsi JS untuk membuka modal detail pesanan dengan aksi penyajian. -->

<!-- A. TAB FILTER STATUS -->
<!-- Menampilkan tab untuk memfilter pesanan berdasarkan status: Dalam Proses (pending/cooking), Selesai (served), atau Semua. -->
